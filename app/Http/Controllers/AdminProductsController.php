<?php namespace App\Http\Controllers;
	...
	class AdminProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Price','name'=>'price','type'=>'number','validation'=>'required|min:1','width'=>'col-sm-10','min'=>'1','step'=>'any'];
			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Colors','name'=>'colors','type'=>'checkbox','validation'=>'required','width'=>'col-sm-10','datatable'=>'colors,title'];
			$this->form[] = ['label'=>'Sizes','name'=>'sizes','type'=>'checkbox','validation'=>'required','width'=>'col-sm-10','datatable'=>'sizes,title'];
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'1|Active;0|In Active','value'=>'1'];
			...
			//$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Colors','name'=>'colors','type'=>'checkbox','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'colors,title'];
			//$this->form[] = ['label'=>'Sizes','name'=>'sizes','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'sizes,title'];
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'1|Active;0|In Active'];
			# OLD END FORM
	    ...
	    */    
	    public function hook_row_index($column_index,&$column_value) {	        
	    	...
	    	$settings=DB::table('settings')->where('id',1)->first();
	          ...
	          if($column_index==2){
	        		$column_value=$settings->currency.''.$column_value;
