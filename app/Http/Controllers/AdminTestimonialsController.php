<?php namespace App\Http\Controllers;
	...
	class AdminTestimonialsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Client Name","name"=>"client_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Client Name','name'=>'client_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
